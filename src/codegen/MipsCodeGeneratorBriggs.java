...
public class MipsCodeGeneratorBriggs {
    ...
    Map<String, String> varToColourr;
    ...
    */
    ...
    public MipsCodeGeneratorBriggs(IRInstruction[] instructions, FunctionBlock functionBlock, SymbolTable symbolTable) {
    ...
    private MipsInstruction getLoadCommand(String register, String operand) {
        ...
        if (varToRegister.containsKey(operand)) {
            if (!varToRegister.get(operand).equals(register)) {
                cmd = new MipsCodeGenerator.move(register, varToRegister.get(operand));
            }
        }
...
//        }
    ...
    private MipsInstruction getStoreCommand(String register, String operand) {
        if (varToRegister.containsKey(operand)) {
            if (!varToRegister.get(operand).equals(register)) {
                return new MipsCodeGenerator.move(varToRegister.get(operand), register);
            }
        }
