...
//                String register = getRegister(false, aOrBIsFloat);
    ...
    static class move implements MipsInstruction {
        ...
        public move(String destination, String source) {
            ...
            this.source = source;
            // if (this.destination.equals("$f21") || this.source.equals("$v0")) {
            //     for (StackTraceElement ste : Thread.currentThread().getStackTrace()) {
            //         System.out.println(ste);
            //     }
            // }
            if (this.source.startsWith("$f") && this.destination.equals("$v0")) {
                // this.source = "$f0";
            ...
            // }
            // if (this.destination.startsWith("$f") && this.source.equals("$v0")) {
            // if (this.source.equals("$v0") || this.source.equals("$f21") || this.destination.equals("$f21") || this.destination.equals("$v0")) {
            //     this.destination = "$f0";
            //     this.source= "$v0";
